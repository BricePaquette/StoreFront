...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class UserDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserFirstName,UserLastName,IsCrewmate")] UserDetail userDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,UserFirstName,UserLastName,IsCrewmate")] UserDetail userDetail)
        {
